...
def main():
    ...
    print("quartile 1 = {}, q2==med = {}, quartile 3 = {}, iqr = {}".format(q1[0], med[0], q3[0], iqr))
    print("q1's idx = {}, med's idx = {}, q3's idx = {}, and list len = {}".format(q1[1], med[1], q3[1], len(data)))
    print("the value at the 82% index is: {}".format(data[round(len(data)*.82)]))
    target = 32
    print("{} occurs at the index position of {} out of {}, for percentage rank of {}".format(target,data.index(target),len(data), (data.index(target)/len(data))))
